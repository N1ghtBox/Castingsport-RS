...
const createWindow = (): void => {
  ...
  ipcMain.handle("generateFinalResults", async (_: any, ...args: any[]) => {
    ...
    if(comp.finalId) json.finals.splice(json.finals.findIndex(x => x.id == comp.finalId), 1, {id:comp.finalId, scores, name: comp.name})
    else {
      let finalId = uuidv4()
      json.finals.push({id:finalId, scores, name: comp.name})
